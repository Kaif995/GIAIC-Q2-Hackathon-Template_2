...
interface IProduct {
  ...
  image: IImage; // Adjust the type as needed
  price: number;
  description: string;
}
...
export default async function ProductPage({ params }: { params: { id: string } }) {
  const product: IProduct = await getProductById(params.id);
    ...
    return (
      ...
      //                 width={300}
      //                 height={300}
      //                 src={urlForImage(product.image).url()} alt="product" />
      //         </div>
      //         <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Add to Cart Button */}
            {/* <button onClick={handleAddToCart} className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors">
              Add to Cart
            </button> */}
